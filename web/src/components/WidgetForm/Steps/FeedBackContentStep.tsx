...
export function FeedBackContentStep({feedbackType, onRestartFeedBackRequested, onFeedbackSent}: FeedbackContentStepProps){
  ...
  return(
    ...
    <footer className="flex gap-2 mt-2">
     ...
     />
      ...
      >
        {isSendingFeedback ? <Loading/> : 'Eviar feedback'}
      </button>
    </footer>
    </form>
    </>
